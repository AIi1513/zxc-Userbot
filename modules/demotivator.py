...
async def demotivator(client: Client, message: Message):
    ...
    font = requests.get("https://github.com/deadboi-zxc/zxc-Userbot_files/blob/main/Times%20New%20Roman.ttf?raw=true")
    f = font.content
    template_dem = requests.get("https://raw.githubusercontent.com/deadboi-zxc/zxc-Userbot_files/main/demotivator.png")
