...
from utils.ytdlp_v4_0 import AudioFile
from utils.ytdlp_v4_0 import VideoFile
...
async def soundcloud(client, message):
    module_dir = "/data/data/com.termux/files/home/ub/ytdl_down/"
    ...
    if link == i:
        await message.edit_text(text="**Будь ласка зачекайте :)**")
        ...
        for data in mas_audio:
            ...
            await message.edit_text(text="**Файл успішно надісланий!**")
            await asyncio.sleep(2)
...
async def youtube(client, message):
    module_dir = "/data/data/com.termux/files/home/ytdlp_down/"
    first_path = os.getcwd()
